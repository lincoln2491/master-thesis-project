...
CREATE TABLE `Couches` (
  `idCouches` int(11) NOT NULL AUTO_INCREMENT,
  `birth_date` date DEFAULT NULL,
  `city` varchar(45) DEFAULT NULL,
  `country` varchar(45) DEFAULT NULL,
  PRIMARY KEY (`idCouches`)
...
LOCK TABLES `Couches` WRITE;
/*!40000 ALTER TABLE `Couches` DISABLE KEYS */;
/*!40000 ALTER TABLE `Couches` ENABLE KEYS */;
UNLOCK TABLES;
